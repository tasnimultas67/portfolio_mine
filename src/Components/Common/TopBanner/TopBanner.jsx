...
export default function TopBanner({handleClickHidden}) {
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-[#ffff00] px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      {/* <div
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm leading-6 text-gray-900">
          <strong className="font-semibold">Help the Palestinian People</strong>
