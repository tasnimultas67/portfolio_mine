    ...
    return (
        <div className="overflow-hidden py-24 sm:py-32 bg-white">
            <div className="w-full m-auto px-5 sm:px-7 md:px-10 lg:px-16 xl:px-16 justify-center">
                <div className=''>
                    <p className="mt-6 text-2xl leading-8 scrollFade text-yellow-400">Concerning Me</p>
                    <p className=" mb-4 text-4xl md:text-5xl lg:text-6xl xl:text-6xl 2xl:text-7xl font-bold text-black tracking-tight leading-none scrollFade mt-5">A hands-on creative with more than <br />{experience} years design experience.</p>
                    <Link to="/about" className="w-[11rem] justify-center group group-* mt-14 flex items-center text-sm relative leading-6 text-black uppercase bg-[#ffff00] px-6 py-3 ">
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 mt-12">
                    <div className="lg:pr-8 lg:pt-4 flex ">
                        <div className="">
                            <p className="scrollFade text-xl sm:text-2xl md:text2xl xl:text-2xl lg:text-2xl 2xl:text-[1.6rem] leading- text-gray-950 Roobert-font">Hello, I am Tasnimul Haque! I'm a {age}-year-old developer and student based in Dhaka, Bangladesh. I completed a Higher Secondary Certificate degree from Bhola Govt College in 2021. Now I am doing BSS(Hons) in the Political Science department.</p>
