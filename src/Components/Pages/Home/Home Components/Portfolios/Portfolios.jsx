...
const Portfolios = () => {
    ...
    return (
            <div className='w-full m-auto px-5 sm:px-7 md:px-10 lg:px-16 xl:px-16 py-28 bg-white'>
                ...
                <Link to="/about" className="w-[11rem] justify-center group group-* mt-10 flex items-center text-sm relative leading-6 text-black uppercase bg-[#ffff00] px-6 py-3 ">
