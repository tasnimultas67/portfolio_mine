...
const Portfolios = () => {
    ...
    return (
            <div className='w-full m-auto px-5 sm:px-7 md:px-10 lg:px-16 xl:px-16 py-36 bg-themeColor'>
                <div className=''>
                    <h1 className='mb-4 text-4xl md:text-5xl lg:text-6xl xl:text-6xl 2xl:text-7xl font-extrabold text-black tracking-tight leading-none'>I collaborated with pioneering leaders to create exceptional products</h1>
                ...
                <Link to="/portfolio" className="w-[11rem] justify-center group group-* mt-10 flex items-center text-sm relative leading-6 text-black uppercase bg-white px-6 py-3 ">
