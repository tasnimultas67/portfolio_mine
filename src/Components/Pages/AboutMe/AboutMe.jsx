                    ...
                    <div className='w-11/12  m-auto'>
                        ...
                        <div className='md:pb-24 pt-20 '>
                            <motion.h1
                                ...
                                className='text-4xl md:text-6xl lg:text-7xl font-extrabold md:max-w-7xl'>Not a dev, designer and most certainly not a role model. <span className='text-themeColor'>Just a stray cat trying to survive.</span>
                            </motion.h1>
                            <motion.p
                            ...
                            <motion.p
                                ...
                                viewport={{ once: true }}
                            className='flex items-center gap-3 text-xl mt-7 md:ml-[10vw]'>
                        ...
                        <div className='md:flex gap-10 flex-row items-center mt-10'>
                            <div className='flex-1 '>
                                ...
                                initial={{ opacity: 0, y: 100 }}
                                    ...
                                    viewport={{ once: true }}
                                    className='text-4xl md:text-7xl text-center md:text-left font-bold text-black'>I enjoy partnering with design-savvy experts.</motion.h1>
                            </div>
