...
const AboutMe = () => {
  ...
  useEffect(() => {
    ...
    return (
        <>
            <div id='aboutme' className="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
                <div className='mx-auto max-w-7xl px-6 lg:px-8'>
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                        ...
                        <div className="-ml-12  p-12 lg:sticky lg:top-6 lg:overflow-hidden">
                            <img className="w-[38rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 md:-ml-4 lg:-ml-0  scrollFade " src={Tasnimul} alt=""/>
                        </div>
                    </div>
                </div>
            </div>
